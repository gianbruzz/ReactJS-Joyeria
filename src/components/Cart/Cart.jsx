  ...
  if( cart.length === 0 ){
    return(
      <div className="empty-cart">
        <h2 className="title-empty-cart">Lo sentimos... No pudimos encontrar productos en el carrito 😥</h2>
  ...
  return (
    <div className="cart" >
      ...
      <div className="info-cart">
        ...
        <button className="button-left-cart">
        <Link to="/checkout" style={{textDecoration:"none"}}>Finalizar compra</Link>
        </button>
